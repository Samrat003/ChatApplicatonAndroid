...
public class ChatActivity extends AppCompatActivity {
    ...
    private EditText MesageInputText;
    ...
    private void IntializeController() {
        ...
        MesageInputText=findViewById(R.id.input_message);
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (dataSnapshot.child("userState").hasChild("state")){
                            ...
                            Log.d("ChatActivity", state);
                            Log.d("ChatActivity", String.valueOf(dataSnapshot.child("userState").child("state").getValue()));
                            if (String.valueOf(dataSnapshot.child("userState").child("state").getValue()).equals("online")){
                                userLastSeen.setText("online");

                            }
                            else if (String.valueOf(dataSnapshot.child("userState").child("state").getValue()).equals("offline") || String.valueOf(dataSnapshot.child("userState").child("state").getValue()).equals("null")){
    ...
    private void SendMessage(){
        String messageText=MesageInputText.getText().toString();
        ...
        if (TextUtils.isEmpty(messageText)){
            ...
            DatabaseReference userMessageKeyRef= RootRef.child("Messages").child(messageSenderId).child(messageReciverId).push();
