...
public class GroupChatActivity extends AppCompatActivity {
    ...
    private String currentGroupName,currentUserID,currentUserName,currentDate,curretnTime;
    ...
    private void InitializeFields() {
        ...
        displayTextMassages=findViewById(R.id.group_chat_text_display);
    ...
    private void SaveMassageInfoToDatabase() {
        ...
        if(TextUtils.isEmpty(message)){
            ...
            curretnTime=currentTimeFormat.format(calForTime.getTime());
            ...
            HashMap<String,Object> MessageInfoMap=new HashMap<>();
                ...
                MessageInfoMap.put("time",curretnTime);
